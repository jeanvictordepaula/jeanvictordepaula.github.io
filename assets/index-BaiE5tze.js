...
`;const s="/logo.svg",c=`
  <span class="brand-logo-bg">
    <img src="${s}" alt="Logo da Marca" class="brand-logo" />
  </span>
`;document.body.insertAdjacentHTML("beforeend",c);const n=`
